    ...
    if (isset($_POST['init']) === true)
    {
        ...
        if (Database::Get()->IsConnected() === true)
        {
            ...
            if ($success === true)
            {
                if ($dropExistingTables === true)
                {
                    if (Database::Get()->ExecuteUnsecure("DROP TABLE IF EXISTS `".Database::Get()->GetPrefix()."events`") !== true)
                    {
                        $success = false;
                    }
                }
            ...
            if ($success === true)
            {
                ...
                $sql .= "`".Database::Get()->GetPrefix()."events` (".
                        "  `id` int(11) NOT NULL AUTO_INCREMENT,".
                        "  `event_type` int(11) NOT NULL,".
                        "  `asylum_seeker_family_name` varchar(255) COLLATE utf8_bin,".
                        "  `asylum_seeker_given_name` varchar(255) COLLATE utf8_bin,".
                        "  `asylum_seeker_address` varchar(255) COLLATE utf8_bin,".
                        "  `asylum_seeker_zip_code` varchar(255) COLLATE utf8_bin,".
                        "  `asylum_seeker_city` varchar(255) COLLATE utf8_bin,".
                        "  `asylum_seeker_email` varchar(255) COLLATE utf8_bin,".
                        "  `asylum_seeker_phone` varchar(255) COLLATE utf8_bin,".
                        "  `date_received` date,".
                        "  `details` text COLLATE utf8_bin,".
                        "  `date_deadline` varchar(255) COLLATE utf8_bin,".
                        "  `creator_name` varchar(255) COLLATE utf8_bin,".
                        "  `creator_email` varchar(255) COLLATE utf8_bin,".
                        "  `creator_phone` varchar(255) COLLATE utf8_bin,".
            ...
            if ($success === true)
            {
                if ($dropExistingTables === true)
                {
                    if (Database::Get()->ExecuteUnsecure("DROP TABLE IF EXISTS `".Database::Get()->GetPrefix()."uploaded_files`") !== true)
                    {
                        $success = false;
                    }
                }
            ...
            if ($success === true)
            {
                ...
                $sql .= "`".Database::Get()->GetPrefix()."uploaded_files` (".
                        "  `id` int(11) NOT NULL AUTO_INCREMENT,".
...
else if ($step == 4)
{
    ...
    echo "        <div>\n".
         ...
         "              <input type=\"text\" name=\"email\" value=\"".htmlspecialchars($userEMail, ENT_COMPAT | ENT_HTML401, "UTF-8")."\" size=\"20\" maxlength=\"255\"/> ".LANG_STEP4_EMAILDESCRIPTION."<br/>\n".
